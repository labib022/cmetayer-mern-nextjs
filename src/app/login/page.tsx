...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-[#e9e9e9] px-4">
      {/* Card */}
      <div className="bg-[#fafafa] rounded-[32px] p-8 flex flex-col gap-8 items-center w-full max-w-[550px] shadow-sm">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 w-full">
          ...
          <button
            type="submit"
            id="sign-in-button"
            className="w-full bg-[#08203c] hover:bg-[#0a2a4e] active:bg-[#061828] text-white font-semibold text-[16px] leading-[1.4] py-4 rounded-[40px] transition-colors duration-200 cursor-pointer"
          >
            Sign in
          </button>
        </form>
        ...
        <button
          ...
          className="w-full bg-[#0b1714] hover:bg-[#162820] active:bg-[#0a1510] text-white font-medium text-[16px] leading-[24px] py-[10px] px-4 rounded-[40px] flex items-center justify-center gap-3 transition-colors duration-200 border border-[#0b1714] cursor-pointer"
        >
